...
public class Blood extends Window{
    ...
    public Cell[] cell_status; //cell image position structure
    ...
    public boolean cellClicked,toolsClicked; //for click status check
    private long milliSec,pausedTime; //game resume time in milisec
    private int counter; //counting non-cancer cell
    public boolean running,paused; //game running detector
